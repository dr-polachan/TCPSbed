...
# load files
execfile("./src/ss_com_settings.py")
execfile("./src/ss_com_fwd_kinematic.py")
execfile("./src/ss_com_bwd_haptic.py")
#execfile("./src/ss_com_bwd_video.py")
#execfile("./src/ss_com_bwd_audio.py")
execfile("./src/ss_com_bwd_ping.py")
