...
m = 20 #number of step response curves
Index = 0
...
#for i in range(40, 50):
    ...
    #df = pd.read_csv("H:/testdataDeepak/data"+str(i)+".txt", header=None)
    ...
    elif (df1["data"].iloc[0] == 100): # if not equal to 100 imply, data file is corrupted
...
print "-------"
print "Summary::"
print "Corrupted data sets/files", round(100-100*len(df_dataGoodness)/m,2),"%"
...
#print "tcpsCQM =", round((1.5/round(df_data.iloc[:,i].mean(),3)),3), "@ p=", round(100*(goodnessCount/(m*1.0)),2),"%"
